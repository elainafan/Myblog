...
$$
R \upharpoonright A = \{\langle x,y \rangle | \langle x,y \rangle \in R,x \in A \}
$$
...
$$
[x]_R = \{y | y \in A, \langle x,y \rangle \in R\}
$$
...
不一定。右侧是笛卡尔积，而左侧只是从 $A$ 中删去若干有序对，两边的对象类型已经不同。取 $A=B=C=\{1\}$，左侧为 $\{1\}$，右侧为 $\emptyset$，故等式不成立。
...
$$
A=\{a,b,d,e,f\},\quad R=\{\langle a,b \rangle,\langle b,a \rangle,\langle d,e \rangle,\langle e,f \rangle,\langle f,d \rangle \}
$$
...
$$
R_1=\{\langle 1,1 \rangle , \langle 2,3 \rangle \}, \quad
R_2=\{\langle 1,2 \rangle, \langle 3,3 \rangle \}.
$$

这两个关系本身都是传递的，但

$$
R_1 \circ R_2 = \{\langle 2,3 \rangle, \langle 1,2 \rangle\}.
$$
...
$$
A/R=\{A_1,A_2,\ldots,A_m\}, \quad |A_i|=n_i.
$$
...
$$
A=\{\langle \emptyset,\{\emptyset,\{\emptyset \}\} \rangle,\langle \{\emptyset \}, \emptyset \rangle \}
$$
...
$$
R_1=\{\langle 1,2 \rangle,\langle 3,5 \rangle \}, \quad
R_2=\{\langle 2,3 \rangle, \langle 5,4 \rangle \}.
$$

则

$$
R_1 \circ R_2=\{\langle 1,3 \rangle, \langle 3,4 \rangle \}.
$$
...
12. 对任意非空集合 $A$，$A$ 的非空子集族 $P(A)-\{\emptyset\}$ 是否构成 $A$ 的划分？

需要按 $A$ 的大小讨论。若 $|A|=1$，则 $P(A)-\{\emptyset\}$ 中只有 $A$ 本身，构成划分；若 $|A|>1$，不同的非空子集会发生交叠，因此不构成划分。
