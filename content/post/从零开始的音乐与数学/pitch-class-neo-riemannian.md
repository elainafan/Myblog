...
![](assets/pitch-class-neo-riemannian/34.png)
...
![](assets/pitch-class-neo-riemannian/35.png)
...
![](assets/pitch-class-neo-riemannian/36.png)

![](assets/pitch-class-neo-riemannian/37.png)
...
![](assets/pitch-class-neo-riemannian/38.png)

- 用正六边形对应的``6个三和弦``共同包含的这个``唯一的音类``作为这个六边形的``标号``，于是把音网表示为``若干带标号的正六边形``构成的图形。

![](assets/pitch-class-neo-riemannian/39.png)

- 同时，音网中``两个六边形是否相邻``，在某种程度上反映了``这两个六边形的标号所构成的音程是否协和``。
- 然后，由于每个六边形都有标号，把它们连起来，可以得到音网的``对偶图``。

![](assets/pitch-class-neo-riemannian/40.png)

- 进而可以得到对偶音网中三角形的表示形式：

![](assets/pitch-class-neo-riemannian/41.png)

- 在``十二平均律体系``内，音网实际上``并不是无限延展的``，而是在水平和垂直两个方向出现``周期性的重复``。在几何上，这样的一个具有``双周期``的图形构成一个``环面``。
- 下面是``和弦``在音网上的表示：

![](assets/pitch-class-neo-riemannian/42.png)

- 同时，音网上还可以找出``音阶``：

![](assets/pitch-class-neo-riemannian/43.png)

![](assets/pitch-class-neo-riemannian/44.png)

![](assets/pitch-class-neo-riemannian/45.png)
