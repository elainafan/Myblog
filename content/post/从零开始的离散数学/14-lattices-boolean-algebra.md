...
有补格中每个元素都存在唯一的补元，可以把求补元的运算当做布尔代数中的一种一元运算，记作 $\langle B,\wedge,\vee,',0,1 \rangle.\forall a \in B,a'$ 是 $a$ 的补元。
...
$$
\{\langle 0 \rangle,\langle 4 \rangle,\langle 6 \rangle,\langle 2 \rangle\},\quad
\{\langle 6 \rangle,\langle 3 \rangle,\langle 2 \rangle,\langle 1 \rangle\}
$$

$$
\{\langle 0 \rangle,\langle 4 \rangle,\langle 3 \rangle,\langle 1 \rangle\},\quad
\{\langle 0 \rangle,\langle 4 \rangle,\langle 2 \rangle,\langle 1 \rangle\}
$$

$$
\{\langle 0 \rangle,\langle 6 \rangle,\langle 2 \rangle,\langle 1 \rangle\},\quad
\{\langle 0 \rangle,\langle 6 \rangle,\langle 3 \rangle,\langle 1 \rangle\}
$$
