...
menu:
    main: 
        ...
        params:
            icon: user
---
这是一个学习向博客，建立它是受Arthals学长启发，记录我的学习历程并分享笔记。      
## 关于我
- 个人不喜欢透露真名，但是你可以叫我elainafan，或者更亲昵地叫我小e。  
- 又或者，你可能在现实中认识我，可以叫我其他绰号，也没关系(但请勿评论区开盒)。  
- 目前就读于北京大学计算机科学与技术专业，是一名干啥都菜的蒟蒻。    
- 平时会打打A享受掉大分的感觉，但是是超级蒻的蒟蒻，如果你有感兴趣的算法题目可以一起讨论呀~
- 喜欢长跑、围棋、旅游与发呆，啊对了，还有睡觉（笑）。
- 喜欢老番和美剧，具体可见左侧番剧页面，随兴放了一些喜欢的番。
...
- 2025.09.18 博客的代码进行了重构。
- 2025.10.01 新系列``计算机系统导论``开始更新。
- 2025.10.26 加入了新页面``番剧``，修改了多处样式。
- 2025.11.02 解决了困扰许久的图片样式问题。
- 2025.11.07 博客迁移至新域名``elainafan.one``！
- 2025.11.21 博客评论区脚本更换为更方便的``giscus``。
- 2025.11.21 使用``PJAX``和``Aplayer``实现``无刷新加载``与``不中断音乐播放器``！
- 2026.01.04 《魔女之旅》宣布制作新作剧场版。
- 2026.01.09 加入了新页面``图库``。
- 2026.01.10 实现了``文章加密``功能！
- 2026.01.10 新系列``动漫``和``算法``开始更新。
- 2026.03.10 新系列``随机算法``开始更新。
- 2026.03.13 重构``番剧``页面，导入Bilibili api，使其能抓取博主最新B站追番。
## 最后的最后
目前是尚未成熟的小站，欢迎各位来访、评论，更欢迎在``友链``页面评论区留下联系方式添加友链！