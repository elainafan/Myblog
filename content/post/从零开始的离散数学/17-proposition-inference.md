...
设有前提 $A_1,A_2,\ldots,A_k,$ 结论 $B$ 和公式序列 $C_1,C_2,\ldots,C_l.$ 如果每一个 $C_i$ 是某个 $A_j$ 或者可由序列前面的公式应用推理规则得到，并且 $C_l=B,$ 那么称公式序列是由 $C_1,C_2,\ldots,C_l$ 由 $A_1,A_2,\ldots,A_k$ 推导出 $B$ 的证明.
