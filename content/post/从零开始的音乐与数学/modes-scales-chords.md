...
![](assets/modes-scales-chords/7.png)

- 自然大调中，七个音都有名字，如下

![](assets/modes-scales-chords/8.png)

- ``自然小调``是由两个不同的四声音阶结合而成，中间相隔``大二度``。
- 两个四声音阶的四个音级之间的音程分别为``大二度、小二度、大二度``和``小二度、大二度、大二度``。
- 以下是以 $A$ 为主音的自然小调音阶：

![](assets/modes-scales-chords/9.png)

- ``自然小调``中，将 $VII$ 级导音``升高半音``，得到``和声小调``。
- 以下是以 $a$ 为主音的和声小调音阶

![](assets/modes-scales-chords/10.png)

- ``和声小调``的第 $VI,VII$ 级之间构成一个``增二度音程``，将 $VI$ 也升高半音，得到``旋律小调``。
- 以下是以 $a$ 为主音的旋律小调

![](assets/modes-scales-chords/11.png)
...
![](assets/modes-scales-chords/12.png)
...
![](assets/modes-scales-chords/13.png)

- 根据调式将``需要升高或者降低``的``变音记号``统一写在``五线谱谱号的右边``，称为``调号``。

![](assets/modes-scales-chords/14.png)
...
![](assets/modes-scales-chords/15.png)

- 把24个大小调看做一个``家族``，成员之间的关系有远近之分，每一个调式都有5个``近关系调``，如下。

![](assets/modes-scales-chords/16.png)

![](assets/modes-scales-chords/17.png)
...
![](assets/modes-scales-chords/22.png)
...
![](assets/modes-scales-chords/23.png)
...
![](assets/modes-scales-chords/24.png)
...
- 用下标 $6$ 和 $\substack{6 \\ 4}$ 分别表示三和弦的``第一转位``和``第二转位``。
...
![](assets/modes-scales-chords/25.png)

- 和声是音乐中最重要三个基本要素之一，和声进行的规律是一个逐步演化的历史过程。
- 大调式的和弦进行

![](assets/modes-scales-chords/26.png)
