...
数据范围：$1 \leq n,m \leq 2 \cdot 10^5,1 \leq h \leq 10^9$。
...
数据范围：$1 \leq n,m,k \leq 2 \cdot 10^5$。
...
数据范围：$2 \leq n \leq 2 \cdot 10^5, 1 \leq l_i \leq 10^5, 0 \leq a_i \leq 10^6$，$\sum l_i \le 2 \cdot 10^5$。
